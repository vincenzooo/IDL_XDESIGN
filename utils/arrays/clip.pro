function clip, data, min=mmin,max=mmax,clipvalue=clipvalue,$
...
;   
  ...
  if n_elements(refimage) eq 0 then refimage=data*0 else $
    if n_elements(refimage) eq 1 then refimage= data*0+refimage
