...
pro multipsd,filelist,roi_um=roi_um,nbins=nbins,sectionlevel=sectionlevel,outname=outname,$
  ...
  groups=groups,groupnames=groupnames,_extra=extra
...
for i=0,nfiles-1 do begin
  ...
  extractpsd,filelist[i],roi_um=roi_um_m[*,i],nbins=nins,$ ;img_dir='test',wplot=[1,2,3],$
    ...
    levelPartial=levelPartial,partialStats=partialStats,fCut=fCut,_extra=extra
...
pro test_multi_psd
  ...
  filelist=['/test/multipsd/A01_00F_L.csv',$
            '/test/multipsd/A01_00F_C.csv',$
            '/test/multipsd/A01_00F_R.csv']
  author='Vincenzo Cotroneo'       
  outfolder='/test/multipsd/results'
  outname='A01_00F'   
