...
simbolx={name:"Simbol X", angles:[0.1,0.23], energy:[0.5,80.],color:0,labeloffset:[0.07,2.5],$
	linestyle:0}
edge={name:"EDGE/XENIA", angles:[0.8,1.8], energy:[0.5,6.],color:1,labeloffset:[0.95,3],$
	linestyle:0}
...
plot, 90.-theta,R_coated[*,i_en4500]^2,xtitle='Incidence angle (deg)',ytitle='Square reflectivity',$
	title='Square reflectivity vs angle at 4.5 keV'
oplot, 90.-theta,R_bare[*,i_en4500]^2,color=100,linestyle=2
legend,["Pt + C(80 A)","Pt"],position=12,color=[!P.color,100],linestyle=[0,2]
device,/close
device , FILE='gain2acoll_4.5keV.ps'
ysize_st=!D.Y_SIZE
device,ysize=5
plot,  90-theta,area_gain[*,i_en4500],ytitle='Gain (% Acoll)',xtitle='Incidence angle (deg)'
