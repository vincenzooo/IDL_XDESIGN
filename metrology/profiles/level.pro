...
if keyword_set(legendre) then begin
  ...
  ; IDL> x=vector(-1.,1.,100) & print,svdfit(x,legendre(x,2),1)
  ;    0.0101010
  ;IDL> x=vector(-1.,1.,100) & print,svdfit(x,legendre(x,2),2)
  ;    0.0101010-2.04422e-008
  ;IDL> x=vector(-1.,1.,100) & print,svdfit(x,legendre(x,2),3)
  ;    -0.500001 1.62772e-007      1.50000
  ;IDL> x=vector(-1.,1.,100) & print,svdfit(x,legendre(x,2),4)
...
;  
;  gives:
;y1=level(x,legendre(x,2),coeff=c,degree=0,legendre=legendre) & print,c
;     0.028569974
;IDL> y1=level(x,legendre(x,2),coeff=c,degree=1,legendre=legendre) & print,c
;     0.028569974  6.8502187e-010
;IDL> y1=level(x,legendre(x,2),coeff=c,degree=2,legendre=legendre) & print,c
;     0.028569974  6.8502187e-010      0.26335703
;IDL> y1=level(x,legendre(x,2),coeff=c,degree=3,legendre=legendre) & print,c
